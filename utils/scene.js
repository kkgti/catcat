...
var ROOMS = [
  { id:'livingroom', name:'客厅', emoji:'🛋️', desc:'温馨客厅，猫咪入门级',
    catCount:3, lives:3, behaviorMult:1.0,
    hintDelay:12, fakeWobbleInterval:[99,99], wobbleStrengthMult:1.0,
    items:ITEM_TEMPLATES, disguises:CAT_DISGUISE_TEMPLATES, bgType:'livingroom' },
  { id:'kitchen', name:'厨房', emoji:'🍳', desc:'美食飘香，猫咪更机警',
    catCount:4, lives:3, behaviorMult:1.2,
    hintDelay:15, fakeWobbleInterval:[15,25], wobbleStrengthMult:0.9,
    items:KITCHEN_ITEMS, disguises:KITCHEN_DISGUISES, bgType:'kitchen' },
  { id:'bedroom', name:'卧室', emoji:'🛏️', desc:'安静卧室，狡猾猫出没',
    catCount:5, lives:2, behaviorMult:1.5,
    hintDelay:18, fakeWobbleInterval:[10,18], wobbleStrengthMult:0.8,
    items:BEDROOM_ITEMS, disguises:BEDROOM_DISGUISES, bgType:'bedroom' },
  { id:'bathroom', name:'浴室', emoji:'🛁', desc:'水汽弥漫，猫咪隐匿',
    catCount:5, lives:2, behaviorMult:1.8,
    hintDelay:22, fakeWobbleInterval:[6,14], wobbleStrengthMult:0.7,
    items:BATHROOM_ITEMS, disguises:BATHROOM_DISGUISES, bgType:'bathroom' },
  { id:'study', name:'书房', emoji:'📚', desc:'书海迷宫，大师级挑战',
    catCount:6, lives:2, behaviorMult:2.2,
    hintDelay:28, fakeWobbleInterval:[4,10], wobbleStrengthMult:0.6,
